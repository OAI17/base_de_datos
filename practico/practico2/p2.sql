...
SELECT CountryCode, LanguageCountry, Percentage FROM countrylanguage WHERE IsOfficial = 'T';
UPDATE countrylanguage SET Percentage = 100.00 WHERE CountryCode = 'AIA';
